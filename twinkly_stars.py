...
s = 720 # width and height of frame
h = 720
w = 1280
nframes = 100
...
#%% determine random starting positions for starss

n_stars = 100

r_seq = np.arange(0.0010,0.0030,0.0001)
r_seq = list(r_seq)

c_seq = np.arange(0.5,0.9,0.1)
c_seq = list(c_seq)

stars = []
seed(2)
for _ in range(n_stars):
    stars.append( (random(), random(), choice(r_seq), choice(c_seq)) )
...
#%% save as GIF
images[0].save('stars_twinkle_2.gif',
               save_all=True,
